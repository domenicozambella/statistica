...
{\color{brown}Esempi: \hyperref[Fumatori_Bayes]{Fumatori (regola di Bayes) \faShare}
\\
...
%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%
\hfill\rlap{.}\clearpage\section{Esperimenti ripetuti: prodotto di spazi di probabilità}
...
\hfil$\Pr(r)=1/2$\hfil $\Pr(b)=3/8$\hfil $\Pr(n)=1/8$

Oppure $\Omega=\{1,\dots,16\}$ e posto $B=\{1,\dots,8\}$, $R=\{9,\dots,14\}$, $N=\{15,16\}$ stipuliamo che 


\hfil$\Pr(i)=1/16$\hfil per ogni $i=1,\dots,16$.
...
\def\ceq#1#2#3{\parbox{13ex}{$\displaystyle #1$}\medrel{#2}$\displaystyle  #3$}
...
%%%%%%%%%%%%
%%%%%%%%%%%%
\hfill\rlap{.}\clearpage\hfill\textbf{Regola di Bayes}\subsection{Hemophilia}
\label{Hemophilia}
