...
\ceq{}{=}{P\big(W\le w_0-|w_0-w|\big) + P\big(W\ge w_0+|w-w_0|\big)}. 
...
\ceq{}{=}{P\big(W\le w\big) + P\big(W\ge w\big)}.
...
\ceq{\hfill P(T_+\mathrel|H_0)}{=}{P(X\ge k\mathrel|H_0)\quad=\quad\sum^n_{i=k} {n\choose i}\bigg(\frac12\bigg)^i\bigg(1-\frac12\bigg)^{n-i}=\quad\frac1{2^n}\sum^n_{i=k+1} {n\choose i}}
...
\ceq{\hfill P(T_-\mathrel|H_A)}{=}{P(X< k\mathrel|H_A)\quad=\quad\sum^{k-1}_{i=1} {n\choose i}p^i(1-p)^{n-i}}
