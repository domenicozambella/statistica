...
\subsection{Intervallo di confidenza: normale con varianza nota}
...
%%%%%%%%%%%%
%%%%%%%%%%%%
\hfill\rlap{.}\clearpage\subsection{Intervallo di confidenza: normale con varianza ignota}
\label{IC_varianza_ignota}


Esempi: \hyperref[ICTesempio1]{\faShare}
...
%%%%%%%%%%%%
\hfill\rlap{.}\clearpage\
\subsection{Esempio calcolo intervallo si confidenza}
\label{ICTesempio1}
...
Come era da aspettarsi, a parità di confidenza, l'errore è più piccolo.
