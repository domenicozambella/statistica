...
\begin{itemize}
\item Per quanto possibile, meglio separare teoria ed esempi/esercizi/spegazioni. 
...
Introduciamo due v.a.\@ di Bernoulli $X_1:\Omega^2\to\{0,1\}$ e $X_2:\Omega^2\to\{0,1\}$.  
...
\ceq{\hfill P(X{=}k)}{=}{{n\choose k}p^k(1-p)^{n-k}}
...
Se $n$ \`e il numero di individui, $2n$ è il numero totale di copie dei due alleli. La frazione di $a$ sul totale è (indichiamola con $p_a$)
