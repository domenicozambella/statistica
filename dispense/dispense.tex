...
{\tt pt(t,n)} = $P(T\le t)$ per $T\sim t(n)$
\hfill
{\tt qt($\alpha$,n)=t}, dove $P(T\le t)=\alpha$ per $T\sim t(n)$
...
$p_0=10\%$\\
$p=$  prevalenza di mancini tra i figli di genitori mancini\\
$\sigma_0=\sqrt{n\, p_0(1-p_0)}$\\
$n=1000$\\
$x$ frequenza rilevata\\
$z=\dfrac{x - \mu_0}{\sigma_0/\sqrt{n}}=\dfrac{x - \mu_0}{\sqrt{p_0(1-p_0)}}$\\

\begin{itemize}
\item[1.] $H_0$:\ $p=p_0$ 
\item[2.] $H_A$:\ $p>p_0$ 
\item[3.] Z-test a una coda (coda superiore)
\item[4.] Il valore di soglia per $z$ è $z_\alpha$ tale che $\alpha=\Pr(Z>z_\alpha)$.\\
Quindi $z_\alpha\ =\ ${\tt qnorm(1-$\alpha$)}\\
Quindi il valore di soglia per la frequenza è $x_\alpha\ =\ z_\alpha\sqrt{p_0(1-p_0)} +\mu_0$.
\end{itemize}
...
\item[2.] Qual è l'ipotesi alternativa~?
\item[3.] Quale test dobbiamo usare~?
\item[3.] Qual è il p-valore ottenuto dal valore di $\bar x$ misurato~?
