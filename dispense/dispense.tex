...
Una variabile aleatoria $X$ si dice di \emph{Bernoulli\/} se $\range X=\{0,1\}$, che spesso si abbrevia scrivendo \emph{$X\in\{0,1\}$}.
...
%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%
\hfill\rlap{.}\clearpage\section{Indipensenza stocastica}
...
%%%%%%%%%%%%
%%%%%%%%%%%%
\hfill\rlap{.}\clearpage\hfill\textbf{Pobabilità totali}
...
$D=\{{\rm rosso, giallo, blu}\}$,\hfil $a_{{\rm rosso}}=2$,\hfil $a_{{\rm blu}}=6$,\hfil $a_{{\rm giallo}}=1$
